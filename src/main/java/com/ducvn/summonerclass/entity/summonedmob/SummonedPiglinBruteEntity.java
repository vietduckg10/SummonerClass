...
public class SummonedPiglinBruteEntity extends PiglinBruteEntity implements ISummonedEntity {
    private UUID target;
    private UUID master;
    ...
    public SummonedPiglinBruteEntity(EntityType<? extends SummonedPiglinBruteEntity> p_i225714_1_, World p_i225714_2_) {
