...
public class SummonedSkeletonEntity extends AbstractSkeletonEntity implements ISummonedEntity {
    private UUID target;
    private UUID master;
    ...
    public SummonedSkeletonEntity(EntityType<? extends SummonedSkeletonEntity> p_i48549_1_, World p_i48549_2_) {
    ...
    public boolean isInvisibleTo(PlayerEntity player) {
        if (player.getScoreboardName().equals(this.getCustomName().getString().replace("'s skeleton",""))){
            return false;
        }
        else {
