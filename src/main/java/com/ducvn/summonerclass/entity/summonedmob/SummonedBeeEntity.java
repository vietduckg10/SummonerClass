...
public class SummonedBeeEntity extends BeeEntity implements ISummonedEntity {
    private static final DataParameter<Boolean> DATA_EASTER_EGG_ID = EntityDataManager.defineId(SummonedBeeEntity.class, DataSerializers.BOOLEAN);
    private UUID target;
    private UUID master;
    ...
    public SummonedBeeEntity(EntityType<? extends SummonedBeeEntity> p_i225714_1_, World p_i225714_2_) {
    ...
    public boolean isInvisibleTo(PlayerEntity player) {
        if (player.getScoreboardName().equals(this.getCustomName().getString().replace("'s bee",""))){
            return false;
        }
        else {
