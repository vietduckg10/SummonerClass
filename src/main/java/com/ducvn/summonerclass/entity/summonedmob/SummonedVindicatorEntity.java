...
public class SummonedVindicatorEntity extends VindicatorEntity implements ISummonedEntity {
    private static final DataParameter<Boolean> DATA_BABY_ID = EntityDataManager.defineId(SummonedVindicatorEntity.class, DataSerializers.BOOLEAN);
    private UUID target;
    private UUID master;
    ...
    public SummonedVindicatorEntity(EntityType<? extends SummonedVindicatorEntity> p_i225714_1_, World p_i225714_2_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new SummonedVindicatorEntity.AttackGoal(this));
    ...
    public boolean isInvisibleTo(PlayerEntity player) {
        if (player.getScoreboardName().equals(this.getCustomName().getString().replace("'s vindicator",""))){
            return false;
        }
        else {
