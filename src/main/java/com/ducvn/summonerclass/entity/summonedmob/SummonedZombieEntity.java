...
public class SummonedZombieEntity extends ZombieEntity implements ISummonedEntity {
    private static final DataParameter<Boolean> DATA_EASTER_EGG_ID = EntityDataManager.defineId(SummonedZombieEntity.class, DataSerializers.BOOLEAN);
    private UUID target;
    private UUID master;
    ...
    public SummonedZombieEntity(EntityType<? extends SummonedZombieEntity> p_i48549_1_, World p_i48549_2_) {
    ...
    public boolean isInvisibleTo(PlayerEntity player) {
        if (player.getScoreboardName().equals(this.getCustomName().getString().replace("'s zombie",""))){
            return false;
        }
        else {
